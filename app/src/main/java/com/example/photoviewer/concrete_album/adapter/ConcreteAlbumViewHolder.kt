...
class ConcreteAlbumViewHolder(itemView: View, private val onClickItem: ConcreteAlbumClickListener?) :
    ...
    fun bind(photo: Photo) {
        ...
        containItem?.setOnClickListener { onClickItem?.onConcreteAlbumClicked(photo) }
    }
}